  ...
  return (
    <div className="w-full flex flex-col items-center justify-start gap-10">
      ...
      <p className="font-[400] text-white-main sm:text-[24px] text-[16px]">
        ...
        the "To" field, paste the GHOST AI contract address:{" "}
        <a
          href="https://Ethscan.com/address/0x463464927671a2e8d406A1a3E64093D42a181C44"
          className="font-[400] text-[14px] sm:text-[24px] text-brand-main"
        >
         0x463464927671a2e8d406A1a3E64093D42a181C44.
        </a><br/>
        Set the desired amount of GHOST AI tokens you want to buy and click the "Swap" button.
      </p>
    </div>
  );
};
